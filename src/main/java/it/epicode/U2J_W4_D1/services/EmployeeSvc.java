package it.epicode.U2J_W4_D1.services;

import it.epicode.U2J_W4_D1.auth.auth.AppUser;
import it.epicode.U2J_W4_D1.auth.auth.AppUserRepository;
...
import it.epicode.U2J_W4_D1.exceptions.AlreadyExistsException;
import it.epicode.U2J_W4_D1.exceptions.UploadException;
import it.epicode.U2J_W4_D1.repositories.EmployeeRepository;
import it.epicode.U2J_W4_D1.repositories.ReservationRepository;
...
@Autowired
    ...
    public Employee deleteEmployee(Long employeeId) {
        Employee employee = employeeRepository.findById(employeeId)
                .orElseThrow(() -> new RuntimeException("Employee not found"));
        AppUser user = userRepository.findByEmployee(employee).get();
        if (user != null) {
            user.setEmployee(null); // Rimuove la relazione
